...
const StyledTabPanel = styled.div`
  ...
  .logo-container {
    ...
    width: 40%; /* Adjust width to a percentage */
    margin-top: 0%; /* Space between logo and company name */
    border-radius: var(--border-radius);
    background-color: var(--background-color);
    padding: 0%; /* Padding can be adjusted as a percentage */
  }
                        ...
                        <CSSTransition key={i} in={activeTabId === i} timeout={250} classNames="fade">
                          <StyledTabPanel
                            ...
                            <div className="logo-container">
                              <a href={url ? url : '#'}>
                                <GatsbyImage image={image} alt={title} className="company-logo" />
                              </a>
                            </div>
